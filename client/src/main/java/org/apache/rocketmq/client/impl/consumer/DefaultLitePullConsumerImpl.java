...
//                启动topic消息队列变动监听，一般发生在topic扩展的时候
                startScheduleTask();
...
//    30s一次
    ...
    private void operateAfterRunning() throws MQClientException {
        ...
        if (subscriptionType == SubscriptionType.SUBSCRIBE) {//启动时从namesrv拉取topic订阅信息
